...
import br.com.bengalamobile.contatos.TranslationService;
...
public class MainActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (pref.getBoolean("gravarLatLon", false)) {
	...
	protected void onDestroy() {
		stopService(new Intent(getApplicationContext(), TranslationService.class));
		super.onDestroy();
	}
	...
	public void buildAlertMessageNoGps() {
		...
		builder.setMessage("O GPS deve estar ativado para esta funcionalidade.\nDeseja ativar?").setCancelable(false)
